...
export function Footer() {
  ...
  return (
    <>
      <div className="flex justify-center p-20 bg-[#16161c] border-t border-t-[#343445]  ">
        <div className="flex w-[1280px] flex-col">
          <div className="flex py-12 px-0 items-center w-auto pr-3 border-b border-b-[#343445]">
            <div className="flex">
            ...
            <div className="flex flex-1 gap-16 justify-center">
              <a
                ...
                className=" hover:text-[#6354b8] cursor-pointer items-center text-lg text-white"
              >
                Exchange
              </a>
              <a
                onClick={() => scrollToSection("trackOrder")}
                className=" hover:text-[#6354b8] cursor-pointer items-center text-lg text-white"
              >
                Track Order
              </a>
            ...
            <div className="flex justify-end gap-3">
              <a
                ...
                target="_black"
                className="text-white hover:text-[#6354b8] cursor-pointer"
              >
                <svg
              ...
              <a href="https://t.me/VeilExchange" target="_black" className="text-white hover:text-[#6354b8]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <a href="https://docs.veil.exchange/" target="_black" className="text-white hover:text-[#6354b8]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="flex pt-11 justify-between">
            <a href="/tos" className=" cursor-pointer font-inter text-[#8756DA]">Terms of Service</a>
            <a className="font-inter text-[#8756DA]">
